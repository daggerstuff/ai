...
FILES_TO_UPLOAD = [
    # The Large Datasets
    "ai/training/data/final_corpus/merged_dataset_raw.jsonl",
    "ai/training/data/ULTIMATE_FINAL_DATASET_cleaned.jsonl",
    "ai/training/data/ULTIMATE_FINAL_DATASET.jsonl",
    "ai/training/configs/stage_configs/ULTIMATE_FINAL_DATASET.jsonl",
