...
class QualityMetrics:
    ...
    def calculate_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "crisis_flags_percentage": (
                (self.crisis_flags / self.total_samples * 100)
            ...
            "pii_detected_percentage": (
                (self.pii_detected / self.total_samples * 100)
                if self.total_samples > 0
                else 0.0
            ),
        ...
        if self.semantic_coherence_scores:
            summary["semantic_coherence"] = {
                ...
                "std": (
                    statistics.stdev(self.semantic_coherence_scores)
        ...
        if self.therapeutic_appropriateness_scores:
            summary["therapeutic_appropriateness"] = {
                ...
                "std": (
                    statistics.stdev(self.therapeutic_appropriateness_scores)
        ...
        if self.bias_scores:
            summary["bias"] = {
                ...
                "std": (
                    statistics.stdev(self.bias_scores)
