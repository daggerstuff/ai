...
class TestModule(unittest.TestCase):
    def test_enhanced_crisis_patterns():
        ...
        test_cases = [
            ...
            (
                "Suicide - giving away items",
                "I'm giving away all my things, don't need them anymore",
            ),
            ...
            (
                "Psychotic - paranoia",
                "They're poisoning my food and controlling my thoughts",
            ),
            # New crisis types
            ...
            (
                ...
                "He's getting more violent, I'm afraid he'll kill me",
            ),
            (
                "Domestic violence - children",
                "He threatened to hurt the kids if I leave",
            ),
            # Non-crisis cases
        ...
        expected_high_risk = [
            "Suicide - goodbye message",
            "Suicide - timeline specific",
            "Violence - weapon specific",
            "Psychotic - command voices",
            "Domestic violence - escalation",
        ]
