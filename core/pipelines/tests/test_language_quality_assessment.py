    ...
    def test_assess_high_quality_conversation(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                ...
                Message(
                    role="assistant",
                    content="Certainly. Anxiety regarding public speaking is quite common and understandable. Let's explore several evidence-based techniques that can help you manage these feelings effectively.",
                ),
                Message(
                    role="user",
                    content="That sounds helpful. What specific approaches would you recommend?",
                ),
                Message(
                    role="assistant",
                    content="First, consider implementing progressive muscle relaxation techniques. Additionally, cognitive restructuring can help you identify and challenge negative thought patterns. Furthermore, practicing your presentation multiple times will build confidence and familiarity with the material.",
                ),
            ],
            source="test",
        )
    ...
    def test_assess_poor_quality_conversation(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                ...
                Message(
                    role="assistant",
                    content="thats not good you should of told someone",
                ),
            ],
            source="test",
        )
    ...
    def test_assess_conversation_with_grammar_errors(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                Message(
                    role="user",
                    content="I am went to the store yesterday and he don't like it.",
                ),
                Message(
                    role="assistant",
                    content="I understand. You would of had a better experience if the service was improved.",
                ),
            ],
            source="test",
        )
        ...
        assert any(
            "grammar" in issue.lower() for issue in metrics.issues + metrics.warnings
        )
    ...
    def test_assess_conversation_with_informal_language(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                Message(
                    role="user",
                    content="Yeah, I'm gonna tell you about this awesome thing that happened.",
                ),
                Message(
                    role="assistant",
                    content="Cool! That sounds really neat. Tell me more about this super cool stuff.",
                ),
            ],
            source="test",
        )
        ...
        assert any(
            "informal" in warning.lower()
            for warning in metrics.warnings + metrics.issues
        )
        assert (
            metrics.details["vocabulary_appropriateness_details"]["informal_word_ratio"]
            > 0.1
        )
    ...
    def test_assess_conversation_with_complex_sentences(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                Message(
                    role="user",
                    content="Although I understand the theoretical framework, I'm struggling with the practical implementation because the documentation is incomplete.",
                ),
                Message(
                    role="assistant",
                    content="While documentation gaps can be frustrating, we can work through this systematically. First, let's identify the specific areas where you need clarification, and then we'll develop a step-by-step approach that addresses each component methodically.",
                ),
            ],
            source="test",
        )
        ...
        assert (
            metrics.details["sentence_complexity_details"]["complex_sentence_ratio"]
            > 0.5
        )
    ...
    def test_assess_conversation_with_poor_readability(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                Message(
                    role="user",
                    content="The implementation of the comprehensive therapeutic intervention methodology requires extensive consideration of multifaceted psychological paradigms and interdisciplinary collaborative frameworks that encompass various theoretical orientations and evidence-based practices within the contemporary mental health treatment landscape.",
                ),
                Message(
                    role="assistant",
                    content="The aforementioned therapeutic modalities necessitate sophisticated understanding of complex psychodynamic processes and cognitive-behavioral interventions that integrate seamlessly with humanistic approaches while maintaining adherence to established clinical protocols and professional ethical standards.",
                ),
            ],
            source="test",
        )
        ...
        assert any(
            "long sentences" in warning.lower()
            for warning in metrics.warnings + metrics.issues
        )
    ...
    def test_assess_conversation_with_low_lexical_diversity(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                Message(
                    role="user",
                    content="I feel bad. I feel really bad. I feel very bad about this.",
                ),
                Message(
                    role="assistant",
                    content="You feel bad. I understand you feel bad. Feeling bad is normal when you feel bad.",
                ),
            ],
            source="test",
        )
        ...
        assert metrics.lexical_diversity_score < 0.6
        assert any(
            "diversity" in issue.lower() or "repetitive" in issue.lower()
    ...
    def test_assess_conversation_with_good_coherence(self):
        ...
        conversation = Conversation(
            ...
            messages=[
                ...
                Message(
                    role="assistant",
                    content="I understand that anxiety can be challenging. Let's explore this together.",
                ),
                Message(role="user", content="It affects my daily activities."),
                Message(
                    role="assistant",
                    content="That sounds difficult. Can you tell me more about how it impacts your routine?",
                ),
            ],
            source="test",
        )
