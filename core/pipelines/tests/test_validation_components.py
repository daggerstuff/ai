...
import pytest
from ai.core.pipelines.ingestion_interface import IngestRecord
from ai.core.pipelines.validation import (
    ConversationRecord,
    QualityScore,
    SpeakerTurn,
    validate_record,
...
class TestSpeakerTurn:
    ...
    def test_speaker_turn_sanitization_removes_xss(self):
        ...
        turn = SpeakerTurn(speaker_id="client", content=dangerous_content, metadata={})
        # Should be sanitized
    ...
    def test_speaker_turn_safe_html_preserved(self):
        ...
        turn = SpeakerTurn(speaker_id="client", content=safe_content, metadata={})
    ...
    def test_content_length_validation(self):
        ...
        with pytest.raises(ValueError):
            SpeakerTurn(speaker_id="client", content=long_content, metadata={})
...
class TestConversationRecord:
    ...
    def test_conversation_record_creation(self):
        ...
        turn = SpeakerTurn(speaker_id="client", content="Hello", metadata={})
    ...
    def test_conversation_minimum_turns(self):
        ...
        single_turn = SpeakerTurn(
            speaker_id="client", content="Single message", metadata={}
        )
    ...
    def test_conversation_minimum_speakers(self):
        ...
        same_speaker_turns = [
            ...
            SpeakerTurn(
                speaker_id="client", content="Second", metadata={}
            ),  # Same speaker
        ]
...
class TestQualityScore:
    ...
    def test_compute_initial_quality(self):
        ...
        turns = [
            SpeakerTurn(
                speaker_id="client" if i % 2 == 0 else "therapist",
        ...
        raw_record = IngestRecord(
            ...
            payload={
                ...
                "segments": [
                    ...
                    {
                        "speaker": "therapist",
                        "text": "I understand. Can you describe your anxiety?",
                        "start_time": 5.5,
                    },
                ],
            },
        ...
        raw_record = IngestRecord(
            ...
            payload={
                ...
                "turns": [
                    {
                        "speaker_id": "client",
                        "content": "I'm having mental health issues",
                        "timestamp": "2023-01-01T10:00:00",
                    },
                    {
                        "speaker_id": "therapist",
                        "content": "Let's address your health concerns",
                        "timestamp": "2023-01-01T10:01:00",
                    },
                ],
            },
        ...
        raw_record = IngestRecord(
            ...
            payload={
                ...
                "rows": [
                    {
                        "speaker": "client",
                        "content": "I need help with my depression",
                        "timestamp": "2023-01-01T10:00:00",
                    },
                    {
                        "speaker": "therapist",
                        "content": "I'm here to help. Can you tell me more?",
                        "timestamp": "2023-01-01T10:01:00",
                    },
                ],
            },
