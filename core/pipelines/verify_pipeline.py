...
def verify_imports():
    ...
    try:
        ...
        from ai.core.pipelines.ingestion.edge_case_jsonl_loader import EdgeCaseJSONLLoader
        ...
        from ai.core.pipelines.ingestion.psychology_knowledge_loader import PsychologyKnowledgeLoader
        print("✅ PsychologyKnowledgeLoader imported")

        from ai.core.pipelines.ingestion.pixel_voice_loader import PixelVoiceLoader
