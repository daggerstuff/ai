...
class TierBalancer:
    ...
    def __init__(self, base_path: Path = Path("ai/training_ready/data/datasets")):
...
def create_balanced_training_set(total_samples: int = 50000) -> dict:
    ...
    output_path = Path("ai/training_ready/data/datasets/final_balanced/balanced_train.jsonl")
