...
def verify_files():
    ...
    files_to_check = [
        ...
        "ai/pipelines/orchestrator/schemas/provenance_schema.py",
        "ai/pipelines/orchestrator/services/provenance_service.py",
        "ai/pipelines/orchestrator/services/provenance_integration.py",
        "ai/pipelines/orchestrator/services/provenance_orchestrator_wrapper.py",
        "ai/pipelines/orchestrator/services/README.md",
        "ai/pipelines/orchestrator/cli/provenance_cli.py",
    ]
