...
**File**: `ai/pipelines/services/provenance_service.py`
...
**File**: `ai/pipelines/cli/provenance_cli.py`
...
Run verification:
```bash
python3 ai/pipelines/services/verify_implementation.py
```
...
- **Service README**: `ai/pipelines/services/README.md`
