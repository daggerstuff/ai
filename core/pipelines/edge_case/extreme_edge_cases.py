...
EXTREME_EDGE_CATEGORIES = {
    ...
    "ritualistic_violence_survivor": {
        ...
        "challenges": [
            "extreme_trauma_processing",
            "dissociation_management",
            "secondary_trauma_prevention",
        ],
    },
    ...
    "torture_survivor_perpetrator": {
        ...
        "difficulty": "nightmare",
        "challenges": [
            "victim_perpetrator_cycle",
            "sexual_boundary_violations",
            "immediate_danger_assessment",
        ],
    },
    ...
    "child_trafficking_survivor_recruiter": {
        ...
        "difficulty": "nightmare",
        "challenges": [
            "active_child_endangerment",
            "victim_perpetrator_trauma",
            "criminal_organization_involvement",
        ],
    },
    ...
    "therapist_stalker_planning": {
        ...
        "challenges": [
            ...
            "family_safety",
            "session_continuation_impossible",
        ],
    },
...
if __name__ == "__main__":
    ...
    sys.stdout.write(
        f"📊 {len(EXTREME_EDGE_CATEGORIES)} nightmare-tier scenarios available\n"
    )
    sys.stdout.write(
        "⚠️  WARNING: These scenarios are designed to be profoundly disturbing\n"
    )
    sys.stdout.write(
        "🎯 Purpose: Test therapeutic crisis intervention under extreme conditions\n"
    )
