...
STAGE_TAXONOMY = {
    "stage1_foundation": StageMapping(
        ...
        target_share=0.40,
        source_files=[
            "ai/data/normalized/mental_health_counseling_normalized.jsonl",
            "ai/data/raw/additional_specialized_filtered.json",
            "ai/data/raw/Psychology-6K.json",
        ],
    ...
    "stage2_therapeutic_expertise": StageMapping(
        ...
        target_share=0.25,
        source_files=[
            "ai/data/normalized/cot_reasoning_normalized.jsonl",
            "ai/data/raw/clinical_diagnosis_mental_health.json",
            "ai/data/raw/cultural_nuances.json",
        ],
    ...
    "stage4_voice_persona": StageMapping(
        ...
        source_files=[
            ...
            "ai/data/therapy_in_a_nutshell_voice/exports/therapy_in_a_nutshell_conversations.jsonl",
            "ai/data/patrick_teahan_voice/exports/patrick_teahan__conversations.jsonl",
            "ai/data/crappy_childhood_fairy_voice/exports/crappy_childhood_fairy_conversations.jsonl",
...
def normalize_record(record: Dict[str, Any], source: str, stage_id: str) -> Dict[str, Any]:
    ...
    if isinstance(record, dict):
        for key in record:
            if key not in ['text', 'content', 'message', 'conversation', 'input', 'output']:
