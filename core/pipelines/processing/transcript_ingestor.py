...
try:
    from ai.core.utils.llm_client import LLMClient
except ImportError:
...
class TranscriptIngestor:
    ...
    def __init__(self, source_path: str = ".notes/transcripts", output_base_path: str = "ai/training_ready/data/datasets"):
