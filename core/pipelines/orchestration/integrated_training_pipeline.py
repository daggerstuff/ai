...
from ai.core.pipelines.configs.stages import get_all_stages
from ai.core.pipelines.ingestion.dual_persona_loader import (
    DualPersonaLoader,
)
from ai.core.pipelines.ingestion.edge_case_jsonl_loader import (
    EdgeCaseJSONLLoader,
)
from ai.core.pipelines.ingestion.pixel_voice_loader import (
    PixelVoiceLoader,
)
...
class IntegratedTrainingPipeline:
    ...
    def _run_quality_validation(self, data: list[dict]) -> list[dict]:
        ...
        try:
            from ai.core.pipelines.quality.quality_filter_v1 import QualityFilterV1
