...
```bash
cd ai/pipelines/ingestion/tier_loaders
...
| Component | File Path |
|-----------|-----------|
| HuggingFace MH Loader | `ai/pipelines/ingestion/tier_loaders/huggingface_mental_health_loader.py` |
| DPO Dataset Loader | `ai/pipelines/ingestion/tier_loaders/dpo_dataset_loader.py` |
| Synthetic Distillation | `ai/pipelines/generation/synthetic_data_distillation.py` |
| Empathy Validator | `ai/pipelines/quality/empathy_mental_health_validator.py` |
| Safety Validator | `ai/pipelines/quality/safety_alignment_validator.py` |
| MEMO Integration | `ai/pipelines/ingestion/memo_counseling_dataset.py` |
| DPO Config | `ai/pipelines/training_styles.py` (DPOConfig class) |
| Config | `ai/pipelines/configs/config.py` |
