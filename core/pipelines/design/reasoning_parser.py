...
class ReasoningOutputParser:
    ...
    def __init__(self):
        ...
        self.high_confidence_phrases = [
            'clearly', 'obviously', 'definitely', 'strong indicator',
            'primary focus', 'main category', 'unambiguous'
        ]
        ...
        self.low_confidence_phrases = [
            'unclear', 'ambiguous', 'could be', 'might be',
            'difficult to classify', 'multiple categories'
        ]
    ...
    def _estimate_confidence(self, text: str) -> float:
        ...
        high_count = sum(1 for phrase in self.high_confidence_phrases if phrase in text_lower)
        medium_count = sum(1 for phrase in self.medium_confidence_phrases if phrase in text_lower)
        low_count = sum(1 for phrase in self.low_confidence_phrases if phrase in text_lower)
