...
try:
    from ai.training.scripts.generate_ultra_nightmares import (
...
try:
    from ai.core.sourcing.academic.academic_sourcing import AcademicSourcingEngine
except ImportError:
    AcademicSourcingEngine = None

try:
    from ai.core.sourcing.journal.main import WorkflowExecutor
...
class GenerationWrapper:
    ...
    def __init__(self, workspace_root: Path):
        ...
        self.scripts_dir = self.workspace_root / "ai/training/scripts"
    ...
    def ensure_ultra_nightmares(self, count_per_category: int = 5) -> bool:
        ...
        try:
            ...
            storage_path = (
                self.workspace_root
                / "ai/training_ready/data/datasets/cache/local/nightmare_fuel"
            )
    ...
    def ensure_nemo_synthetic(self, target_count: int = 10000) -> bool:
        ...
        output_dir = (
            self.workspace_root
            / "ai/training_ready/data/datasets/cache/local/nemo_synthetic"
        )
    ...
    def ensure_edge_cases(self, count: int = 10000) -> bool:
        ...
        output_dir = (
            self.workspace_root
            / "ai/training_ready/data/datasets/cache/local/edge_case_synthetic"
        )
        output_dir.mkdir(parents=True, exist_ok=True)
    ...
    def ensure_long_running_extraction(self) -> bool:
        ...
        output_dir = (
            self.workspace_root
            / "ai/training_ready/data/datasets/cache/local/long_running_therapy"
        )
        output_dir.mkdir(parents=True, exist_ok=True)
    ...
    def ensure_academic_sourcing(self, limit_per_query: int = 10) -> bool:
        ...
        try:
            ...
            # absolutely
            output_path = self.workspace_root / "ai/training_ready/data/datasets"
    ...
    def _run_journal_workflow(self, keywords):
        ...
        storage_path = (
            self.workspace_root
            / "ai/training_ready/data/datasets/cache/local/journal_research"
        )
        storage_path.mkdir(parents=True, exist_ok=True)
