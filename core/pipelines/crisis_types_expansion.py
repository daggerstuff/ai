...
class CrisisCategoryManager:
    ...
    def _initialize_categories(self):
        ...
        self._add_category(
            ...
            [
                "Cultural attitudes toward suicide vary widely",
                "Religious beliefs may influence risk",
            ],
            [
                "Mandatory reporting in some jurisdictions",
                "Duty to warn if specific threat exists",
            ],
        )
        ...
        self._add_category(
            ...
            [
                ...
                "Child protection laws if minor involved",
            ],
        )
        ...
        self._add_category(
            ...
            [
                "Involuntary hospitalization if life-threatening",
                "Child protection if minor",
            ],
        )
        ...
        self._add_category(
            ...
            [
                ...
                "Stigma around personality disorders",
            ],
            [
                "Duty to warn if violence threatened",
                "No mandatory reporting for self-harm",
            ],
        )
        ...
        self._add_category(
            ...
            [
                "Cultural interpretations of confusion",
                "Stigma around cognitive impairment",
            ],
    ...
    def get_categories_by_severity(self, severity_level: str) -> List[CrisisCategory]:
        ...
        return [
            ...
            if cat.severity_level == severity_level
        ]
...
if crisis_manager.get_crisis_type_count() == 50:
    ...
    logger.warning(
        f"⚠️  Crisis types count: {crisis_manager.get_crisis_type_count()} (expected 50)"
    )
...
print(
    f"Emergency severity: {len(crisis_manager.get_categories_by_severity('emergency'))}"
)
print(f"High severity: {len(crisis_manager.get_categories_by_severity('high'))}")
print(
    f"Moderate severity: {len(crisis_manager.get_categories_by_severity('moderate'))}"
)
