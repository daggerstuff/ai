...
class JournalingIntegrator:
    ...
    def _create_progression_conversation(
        self, pattern: ProgressPattern
    ) -> List[Dict[str, Any]]:
        ...
        conversations.append(
            {
                ...
                "conversation": {
                    ...
                    "therapy_context": {
                        ...
                        "progress_markers": pattern.emotional_growth
                        + pattern.setback_recovery,
                    },
                },
            }
        )
    ...
    def create_integrated_datasets(
        self, output_path: str = "ai/training_data_consolidated/journaling_enhanced/"
    ):
        ...
        logger.info(
            f"Created {len(datasets)} journaling-enhanced datasets at {output_file}"
        )
