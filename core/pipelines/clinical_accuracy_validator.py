...
class ClinicalAccuracyValidator:
    ...
    CLINICAL_TERMS = {
        "grounded": [
            "cognitive behavioral", "behavioral activation", "sleep hygiene",
            "grounding", "mindfulness", "deep breathing", "progressive muscle",
            "cognitive restructuring", "exposure therapy", "psychoeducation",
            "coping skills", "emotional regulation", "distress tolerance",
            "interpersonal effectiveness", "radical acceptance",
        ],
        "risk": [
            "self-harm", "suicidal", "suicide", "crisis", "safe space",
            "emergency", "safety plan", "risk assessment", "harm reduction",
            "protective factors", "warning signs", "danger", "lethal means",
        ],
    }
    CONTRAINDICATIONS = [
        "replace medication", "stop taking", "discontinue medication",
        "ignore clinician", "ignore doctor", "ignore therapist",
        "stop medication", "skip medication", "forbidden",
        "self-diagnose", "no need for professional",
    ]
    NEGATION_TERMS = {
        "not", "no", "never", "do not", "don't", "does not", "doesn't",
        "did not", "didn't", "should not", "shouldn't", "must not",
        "mustn't", "cannot", "can't", "won't", "will not",
    }
    # Terms that indicate clinical assessment context
    ASSESSMENT_TERMS = [
        "assessment", "evaluate", "evaluated", "screening", "screened",
        "diagnosed", "diagnosis", "examined", "assessed", "measured",
        "assess", "evaluate", "screen", "examine",
    ]
