...
from ai.core.sourcing.journal.documentation.report_generator import ReportGenerator
...
from ai.core.sourcing.journal.integration.pipeline_integration_service import (
