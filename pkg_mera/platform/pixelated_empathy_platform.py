...
class PixelatedEmpathyPlatform:
            ...
            required_scenarios=[
                {
                    ...
                    "objectives": [
                        SessionObjective.CRISIS_INTERVENTION.value,
                        SessionObjective.SAFETY_ASSESSMENT.value,
                    ],
                },
                {
                    ...
                    "objectives": [
                        SessionObjective.CRISIS_INTERVENTION.value,
                        SessionObjective.BOUNDARY_SETTING.value,
                    ],
                },
            ],
            assessment_criteria={
    ...
    async def create_training_session(  # noqa: PLR0913
        self,
        trainee_id: str,
        supervisor_id: str,
    ...
    def _generate_nonverbal_cues(self, client_response) -> dict:
        ...
        if client_response.resistance_level > THRESHOLD_HIGH_TRUST:
            cues.update(
                {
        ...
        elif client_response.therapeutic_progress > THRESHOLD_HIGH_TRUST:
            cues.update(
                {
    ...
    def _generate_intervention_suggestions(self, client_response) -> list[str]:
        ...
        if client_response.resistance_level > THRESHOLD_VERY_HIGH_TRUST:
        ...
        for skill, ratings in evaluation_session["skill_ratings"].items():
            if ratings:
                final_skills[skill] = {
                    ...
                    if len(ratings) >= THRESHOLD_MAX_RATING
