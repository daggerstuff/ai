...
from ai.api.techdeck_integration.error_handling.custom_errors import AnalyticsError, ResourceNotFoundError, ValidationError
...
from ai.api.techdeck_integration.utils.validation import sanitize_input, validate_analytics_request
...
def export_analytics():
    ...
    try:
        ...
        # Create export task
        export_task = _create_export_task(
            redis_client,
            export_type,
            metric_type,
            start_date,
...
def _get_usage_metrics(
    ...
    try:
        ...
        trends = {"direction": trend, "percentage_change": trend_percentage}
...
def _get_dataset_metrics(
    ...
    try:
        ...
        return {"datasets": datasets, "summary": summary, "trends": trends}
...
def _get_real_time_metrics(
    ...
    try:
        ...
        return {"metrics": metrics, "status": status, "alerts": alerts}
