...
class TechDeckServiceConfig:
    ...
    TESTING: bool = field(
        default_factory=lambda: os.environ.get("FLASK_TESTING", "False").lower()
        == "true"
    )

    # Security Configuration
    JWT_SECRET_KEY: str = field(
        default_factory=lambda: os.environ.get("JWT_SECRET_KEY", "jwt-secret-key")
    )
    ...
    RATE_LIMIT_PER_DAY: int = field(
        default_factory=lambda: int(os.environ.get("RATE_LIMIT_PER_DAY", "10000"))
    )

    # Database Configuration
    MONGODB_URI: str = field(
        default_factory=lambda: os.environ.get(
            "MONGODB_URI", "mongodb://localhost:27017/techdeck"
        )
    )
    MONGODB_DATABASE: str = field(
        default_factory=lambda: os.environ.get("MONGODB_DATABASE", "techdeck")
    )
    MONGODB_MAX_POOL_SIZE: int = field(
        default_factory=lambda: int(os.environ.get("MONGODB_MAX_POOL_SIZE", "100"))
    )
    MONGODB_MIN_POOL_SIZE: int = field(
        default_factory=lambda: int(os.environ.get("MONGODB_MIN_POOL_SIZE", "10"))
    )
    ...
    UPLOAD_FOLDER: str = field(
        default_factory=lambda: os.environ.get("UPLOAD_FOLDER", "/tmp/techdeck_uploads")
    )
    ...
    FILE_UPLOAD_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("FILE_UPLOAD_TIMEOUT", "300"))
    )

    # Pipeline Configuration
    PIPELINE_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("PIPELINE_TIMEOUT", "1800"))
    )
    PIPELINE_MAX_CONCURRENT: int = field(
        default_factory=lambda: int(os.environ.get("PIPELINE_MAX_CONCURRENT", "5"))
    )
    PIPELINE_RETRY_ATTEMPTS: int = field(
        default_factory=lambda: int(os.environ.get("PIPELINE_RETRY_ATTEMPTS", "3"))
    )
    PIPELINE_RETRY_DELAY: int = field(
        default_factory=lambda: int(os.environ.get("PIPELINE_RETRY_DELAY", "5"))
    )
    ...
    BIAS_DETECTION_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("BIAS_DETECTION_TIMEOUT", "30"))
    )
    ...
    WEBSOCKET_PING_INTERVAL: int = field(
        default_factory=lambda: int(os.environ.get("WEBSOCKET_PING_INTERVAL", "30"))
    )
    WEBSOCKET_PING_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("WEBSOCKET_PING_TIMEOUT", "10"))
    )
    ...
    RESPONSE_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("RESPONSE_TIMEOUT", "50"))
    )
    ...
    PIPELINE_ORCHESTRATOR_URL: str = field(
        default_factory=lambda: os.environ.get(
            "PIPELINE_ORCHESTRATOR_URL", "http://localhost:8080"
        )
    )
    BIAS_DETECTION_SERVICE_URL: str = field(
        default_factory=lambda: os.environ.get(
            "BIAS_DETECTION_SERVICE_URL", "http://localhost:8081"
        )
    )
    ...
    HEALTH_CHECK_TIMEOUT: int = field(
        default_factory=lambda: int(os.environ.get("HEALTH_CHECK_TIMEOUT", "5"))
    )
    HEALTH_CHECK_INTERVAL: int = field(
        default_factory=lambda: int(os.environ.get("HEALTH_CHECK_INTERVAL", "30"))
    )
