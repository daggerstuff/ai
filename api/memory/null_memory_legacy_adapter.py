...
class NullMemoryLegacySurface(Protocol):
    def add_memory(self, content: str, user_id: str, metadata: dict | None = None, category: str | None = None) -> str: ...
    ...
    def update_memory(self, memory_id: str, new_content: str, metadata: dict | None = None, user_id: str | None = None) -> bool: ...
