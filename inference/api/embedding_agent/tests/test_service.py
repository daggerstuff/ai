...
from ai.inference.api.embedding_agent.models import (
...
from ai.inference.api.embedding_agent.service import EmbeddingAgentService
...
class TestEdgeCases:
    ...
    def test_unicode_text(self, service: EmbeddingAgentService):
        ...
        request = EmbeddingRequest(text="This includes émojis 🎉 and üñíçödé characters 日本語")
