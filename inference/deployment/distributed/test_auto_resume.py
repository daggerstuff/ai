...
from auto_resume_engine import (
    ...
    InterruptionContext,
    InterruptionType,
    ProcessingInterruptionDetector,
    ResumeConfiguration,
    ResumeStrategy,
)
...
class AutoResumeTestSuite:
    ...
    async def test_resume_strategies(self):
        ...
        for i, (interruption_type, _expected_strategy) in enumerate(test_cases):
            ...
            # Make progress
            self.checkpoint_manager.update_process_progress(
                process_id=process_id, completed_steps=10, current_step="Mid-progress"
            )
    ...
    async def test_error_recovery(self):
        ...
        self.checkpoint_manager.update_process_progress(
            process_id=process_id, completed_steps=5, current_step="Mid-progress"
        )
