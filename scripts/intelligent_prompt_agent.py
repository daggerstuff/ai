...
class MultiPatternAgent:
        ...
        for pattern in self.question_patterns:
            ...
            for match in matches:
                ...
                if any(word in text.lower() for word in ["interviewer", "host", "q:"]):
                    confidence += 0.2
                if re.search(
                    r"(?:how|what|why|when|where|can|could|would|should)",
                    question,
                    re.IGNORECASE,
                ):
                    confidence += 0.1
    ...
    def detect_response_boundaries(self, text: str, _question: str | None = None) -> PatternMatch:
    ...
    def generate_contextual_prompt(self, segment: dict, analysis: dict) -> str:
        ...
        if (
            ...
            and analysis["question_confidence"] > 0.4
            and analysis["semantic_coherence"] > 0.3
        ):
