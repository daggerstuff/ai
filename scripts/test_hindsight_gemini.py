...
from ai.memory.hindsight_gemini.manager import GeminiHindsightConfig, GeminiHindsightManager

# Configure logging
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("hindsight_gemini_test")


async def run_cookook_demo():
    """
    Runs a demonstration following the Hindsight + Gemini cookbook.
    """
    logger.info("Starting Hindsight + Gemini Integration Demo")
    ...
    # Initialize Manager
    config = GeminiHindsightConfig(gemini_api_key=gemini_api_key, user_id="empathy_gym_sarah")
