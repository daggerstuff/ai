...
class SmartQAAgent:
    ...
    def analyze_dialogue_structure(self, text: str, sentences: List[str]) -> Dict:
        ...
        has_interview_setup = any(
            indicator in text.lower() for indicator in interview_indicators
        )
        ...
        question_sentences = [
            ...
            or any(
                starter in s.lower()
                for starter in ["how can", "what should", "why do", "when does"]
            )
        ]
            ...
            for i, sentence in enumerate(sentences):
                if "?" in sentence:
                    ...
                    for j in range(i + 1, len(sentences)):
                        ...
                        if any(
                            indicator in sentences[j].lower()
    ...
    def analyze_semantic_content(self, text: str, sentences: List[str]) -> Dict:
        ...
        return {
            ...
            "topic_confidence": (
                max(topic_scores.values()) / len(topic_patterns[main_topic])
                if topic_scores
                else 0.1
            ),
        }
