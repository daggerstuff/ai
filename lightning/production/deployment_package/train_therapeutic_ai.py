...
class TherapeuticTrainer(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
            optimizer, T_max=self.config["training_config"]["num_epochs"]
        )
...
def main():
    ...
    train_dataset = TherapeuticConversationDataset(
        datasets["train"], tokenizer, config["training_config"]["max_length"]
    )
    val_dataset = TherapeuticConversationDataset(
        datasets["validation"], tokenizer, config["training_config"]["max_length"]
    )
    ...
    trainer = L.Trainer(
        ...
        accumulate_grad_batches=config["training_config"][
