...
Use the Data Designer CLI to discover and install published plugin packages from catalogs. See [Discover Plugins](/plugins/discover) for the catalog workflow. See the [example plugin](/plugins/example-plugin) for a complete authoring walkthrough, or jump to [FileSystemSeedReader Plugins](/plugins/file-system-seed-reader-plugins) for filesystem-backed seed reader authoring.
...
- See [FileSystemSeedReader Plugins](/plugins/file-system-seed-reader-plugins) for filesystem-backed seed reader plugins
