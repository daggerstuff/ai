...
class ScenarioGenerator:
    ...
    def generate_scenario(
        self, scenario_type: ScenarioType, difficulty: int, learning_objectives: list[str]
    ) -> TrainingScenario:
        ...
        scenario_id = f"{scenario_type.value}_{difficulty}_{datetime.now(UTC).strftime('%Y%m%d_%H%M%S')}"
