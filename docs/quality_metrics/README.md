...
This documentation covers the comprehensive quality metrics system for
...
- **Conversation Coherence**: Structural integrity assessment (reliability:
  0.84)
- **Emotional Authenticity**: Emotional intelligence assessment (reliability:
  0.79)
...
- [therapeutic_accuracy_definition.json](therapeutic_accuracy_definition.json)
  (4.9 KB)
...
_Generated on 2025-08-03 19:47:00 UTC_
