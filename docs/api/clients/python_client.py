...
class PixelatedEmpathyAPI:
    ...
    def get_quality_metrics(
        self, dataset: Optional[str] = None, tier: Optional[str] = None
    ) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    print(
        f"  Total conversations: {metrics['overall_statistics']['total_conversations']}"
    )
    ...
    print(
        f"  Overall quality: {validation_result['validation_results']['overall_quality']}"
    )
