    ...
    def setup_default_cleanup_rules(self):
        ...
        default_rules = [
            ...
            CleanupRule(
                ...
                policy=CleanupPolicy.AGGRESSIVE,
                conditions={"status": "failed", "age_hours": {">=": 24}},
                actions=["delete"],
                priority=5,
            ),
            CleanupRule(
                ...
                policy=CleanupPolicy.AGGRESSIVE,
                conditions={"storage_usage_percent": {">=": 90}},
    ...
    def _deduplicate_checkpoint(self, checkpoint) -> bool:
        ...
        try:
            ...
            for other_checkpoint in all_checkpoints:
                if (
                    other_checkpoint.checkpoint_id != checkpoint.checkpoint_id
                    and other_checkpoint.checkpoint_type == checkpoint.checkpoint_type
                ):
