    ...
    async def generate_clinical_certification_report(self) -> Dict[str, Any]:
        ...
        certification_report = {
            ...
            "medical_advisory_board": {
                ...
                "approval_votes": latest_board_review.approval_votes
                if latest_board_review
                else 0,
                "total_votes": latest_board_review.total_votes
                if latest_board_review
                else 0,
                "unanimous_approval": latest_board_review.unanimous_approval
                if latest_board_review
                else False,
                "key_recommendations": latest_board_review.key_recommendations
                if latest_board_review
                else [],
