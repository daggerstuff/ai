    ...
    def add_error_handling_decorators(self, file_path: Path, content: str) -> str:
        ...
        for method in critical_methods:
            ...
            def add_decorator(match):
                ...
                decorator = (
                    " " * (indent - 4)
                    + f'@with_retry(component="{file_path.stem}", strategy="default")\n'
                )
...
'''
        ...
        template_path = (
            self.base_path / "enterprise_config" / "enterprise_wrapper_template.py"
        )
    ...
    def run_comprehensive_upgrade(self):
        ...
        print(
            f"✅ {upgraded_count}/{len(self.components_to_upgrade)} components upgraded"
        )
