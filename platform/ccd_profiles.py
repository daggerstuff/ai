...
class CCDProfileTemplates:
    ...
    def get_resistant_template() -> dict[str, Any]:
        ...
        conceptualization.set_formulation(
            summary="Client presents with mandated therapy resistance rooted in emotional avoidance learned through early criticism and reinforced by intellectual strengths. Resistance serves protective function but impairs relational depth.",
    ...
    def get_hostile_aggressive_template() -> dict[str, Any]:
        ...
        # Add hypotheses
        conceptualization.add_hypothesis(
            hypothesis_statement="Aggression functions as maladaptive coping mechanism for underlying fear and helplessness",
            confidence=0.88,
            supporting_evidence=[
        ...
        conceptualization.add_hypothesis(
            hypothesis_statement="Aggression maintains sense of control but damages relationships and creates consequences",
            confidence=0.82,
            supporting_evidence=[
        ...
        # Set formulation
        conceptualization.set_formulation(
            summary="Client presents with chronic aggression rooted in learned effectiveness of violence for control and underlying fear of helplessness. Aggression provides immediate results but creates significant long-term costs.",
    ...
    def get_borderline_traits_template() -> dict[str, Any]:
        ...
        # Add hypotheses
        conceptualization.add_hypothesis(
            hypothesis_statement="Emotional dysregulation functions as maladaptive attempt to regulate overwhelming emotions stemming from attachment trauma",
            confidence=0.9,
            supporting_evidence=[
        ...
        conceptualization.add_hypothesis(
            hypothesis_statement="Splitting and idealization/devaluation cycles function to manage fear of abandonment and maintain sense of safety",
            confidence=0.85,
            supporting_evidence=[
        ...
        # Set formulation
        conceptualization.set_formulation(
            summary="Client presents with borderline personality traits rooted in attachment trauma and emotional hypersensitivity. Emotional dysregulation and interpersonal instability function as maladaptive attempts to manage overwhelming fear of abandonment.",
