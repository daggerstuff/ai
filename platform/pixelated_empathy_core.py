...
class DifficultClientGenerator:
    ...
    def generate_difficult_client(
        ...
        ai_instructions = self._create_ai_instructions(personality_type, difficulty_level)
    ...
    def _create_ai_instructions(
        ...
        return {
            ...
            "difficulty_calibration": f"Maintain level {difficulty_level.value} difficulty - challenging but not impossible",  # noqa: E501
