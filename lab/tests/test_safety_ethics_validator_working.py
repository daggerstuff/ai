...
class MockSafetyEthicsValidator:
    ...
    def validate_content(
        ...
        severity = self._calculate_severity(
            harmful_found, ethical_violations_found, privacy_violations
        )

        # Calculate confidence
        confidence = self._calculate_confidence(
            content, harmful_found, ethical_violations_found
        )
    ...
    def _calculate_severity(
        self, harmful: List[str], ethical: List[str], privacy: List[str]
    ) -> str:
    ...
    def _calculate_confidence(
        self, content: str, harmful: List[str], ethical: List[str]
    ) -> float:
    ...
    def _generate_recommendations(
        ...
        if harmful:
            recommendations.append(
                "Remove harmful content and provide supportive alternatives"
            )
        ...
        if privacy:
            recommendations.append(
                "Remove or redact personally identifiable information for privacy protection"
            )
            recommendations.append("Ensure HIPAA compliance in all communications")

        if not (harmful or ethical or privacy):
            recommendations.append(
                "Content appears safe and ethical - proceed with caution"
            )

        return recommendations

    def validate_therapeutic_response(
        self, response: str, client_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        if any(
            ...
            for word in ["friend", "personal", "my life", "my experience"]
        ):
    ...
    def check_hipaa_compliance(self, content: str) -> Dict[str, Any]:
        ...
        if any(
            ...
            for term in ["name is", "lives at", "works at", "age is"]
        ):
        ...
        return {
            ...
            "recommendations": self._generate_hipaa_recommendations(
                privacy_result, hipaa_violations
            ),
        }

    def _generate_hipaa_recommendations(
        self, privacy: List[str], hipaa: List[str]
    ) -> List[str]:
    ...
    def get_validation_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_confidence": sum(v["confidence"] for v in self.validation_history)
            / total,
        }
...
class TestSafetyEthicsValidator(unittest.TestCase):
    ...
    def test_edge_cases(self):
        ...
        edge_cases = [None, "", "   ", 123, [], {}, "a" * 10000]  # Very long text
    ...
    def test_therapeutic_response_validation(self):
        ...
        result = self.validator.validate_therapeutic_response(
            good_response, client_context
        )
    ...
    def test_hipaa_compliance_checking(self):
        ...
        non_compliant_content = (
            "John Smith, SSN 123-45-6789, has been diagnosed with depression."
        )
    ...
    def test_confidence_scoring(self):
        ...
        clear_violation = self.validator.validate_content(
            "This contains violence and abuse"
        )
        self.assertGreaterEqual(clear_violation["confidence"], 0.9)

        # Safe content should have good confidence
        safe_content = self.validator.validate_content(
            "This is a supportive therapeutic message"
        )
...
class TestSafetyEthicsValidatorIntegration(unittest.TestCase):
    ...
    def test_full_validation_workflow(self):
        ...
        therapeutic_result = self.validator.validate_therapeutic_response(
    ...
    def test_comprehensive_safety_check(self):
        ...
        content_validation = self.validator.validate_content(
            test_response, "therapeutic"
        )
    ...
    def test_violation_escalation(self):
        ...
        serious_violation = (
            "You should hurt yourself and others, here is my personal info: 123-45-6789"
        )
