...
class MockPipelineOrchestrator:
    ...
    def add_stage(
        self, stage_name: str, processor: Any, config: dict[str, Any] | None = None
    ) -> bool:
    ...
    def get_pipeline_status(self) -> dict[str, Any]:
        ...
        if self.execution_history:
            ...
            success_rate = (
                ...
                / len(self.execution_history) * 100
            )
        else:
            last_execution = None
