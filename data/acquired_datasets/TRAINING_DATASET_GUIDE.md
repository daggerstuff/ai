...
1. **For CoT datasets**: Do you want the reasoning to be explicit in outputs, or
   just inform the model's internal processing?

2. **For mixing styles**: Should Tim Fletcher's voice be dominant, or should it
   blend with clinical patterns?

3. **For training duration**: Typical LoRA fine-tuning: 2-5 epochs per stage.
   How aggressive do you want adaptation?

4. **For evaluation**: What metrics matter most - empathy, clinical accuracy, or
   style matching?
