...
This directory contains comprehensive environment management for Pixelated
Empathy across different deployment environments.

## Overview

The environment management system provides:

- **Environment-specific configurations** for development, staging, and
  production
