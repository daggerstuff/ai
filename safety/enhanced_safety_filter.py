...
def test_enhanced_safety_filter():
    ...
    test_cases = [
        ...
        (
            "I'm so angry I could hurt someone. People need to pay for what they've done.",
            "harm_to_others",
        ),
        # Harmful content
        ...
        (
            "You should definitely sue your employer for that. I recommend this specific lawyer.",
            "legal_advice",
        ),
    ...
    for content, test_type in test_cases:
        ...
        if safety_result.filtered_content:
            print(
                f"Filtered Content: {safety_result.filtered_content[:50]}{'...' if len(safety_result.filtered_content) > 50 else ''}"
            )
        ...
        if not is_safe:
            print(
                f"Final Filtered Content: {filtered_content[:50]}{'...' if len(filtered_content) > 50 else ''}"
            )
