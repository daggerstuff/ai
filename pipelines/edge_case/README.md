...
A standalone, portable pipeline for generating challenging therapy scenarios to
train difficult client simulation models.
...
This pipeline is part of the Pixelated Empathy project. Use responsibly for
educational and research purposes in mental health training.
...
**Ready to generate challenging therapy scenarios? Start with the Jupyter
notebook for the best experience!**
