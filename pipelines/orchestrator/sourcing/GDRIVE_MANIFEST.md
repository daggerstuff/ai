...
uv run python ai/pipelines/orchestrator/sourcing/gdrive_manifest_uploader.py --tier processed

# Priority 2: Raw datasets
uv run python ai/pipelines/orchestrator/sourcing/gdrive_manifest_uploader.py --tier raw

# Priority 3: YouTube transcripts
uv run python ai/pipelines/orchestrator/sourcing/gdrive_manifest_uploader.py --tier youtube
```
