...
def integrate_with_final_dataset():
    ...
    final_dataset_path = (
        "../training_data_consolidated/final_datasets/merged_dataset.jsonl"
    )
    output_path = (
        "../training_data_consolidated/final_datasets/ULTIMATE_FINAL_DATASET.jsonl"
    )
    ...
    with (
        open(final_dataset_path, "r") as input_file,
