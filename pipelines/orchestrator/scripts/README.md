...
The legacy integrated probe runner has been removed. Do not treat any old
`run_integrated_probe.py` references as current workflow.
...
The system uses `ai/pipelines/orchestrator/storage_config.py` for S3 configuration:
