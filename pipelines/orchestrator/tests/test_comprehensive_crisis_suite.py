...
class ComprehensiveCrisisTestSuite:
    ...
    def test_multiple_crisis_types(self):
        ...
        for test_case in test_cases:
            ...
            types_match = all(
                expected_type in detected_types for expected_type in expected_types
            )
    ...
    def test_borderline_cases(self):
        ...
        for test_case in test_cases:
            ...
            level_acceptable = (
                result.crisis_level.value[0] in test_case["acceptable_levels"]
            )
    ...
    def _run_crisis_type_tests(self, crisis_type: CrisisType, test_cases: List[Dict]):
        ...
        for test_case in test_cases:
            ...
            level_match = result.crisis_level.value[0] == test_case["expected_level"]
            confidence_ok = result.confidence_score >= (
                test_case["expected_confidence"] - 0.2
            ...
            if "expected_indicators" in test_case:
                ...
                indicators_ok = any(
                    indicator in detected_indicators
                    for indicator in expected_indicators
                )

            overall_pass = (
                type_detected and level_match and confidence_ok and indicators_ok
            )
