...
from ai.pipelines.orchestrator.ingestion_queue import (
    IngestionQueue,
    QueueItem,
    QueueType,
)
from ai.pipelines.orchestrator.s3_connector import S3Config, S3Connector
from ai.pipelines.orchestrator.youtube_connector import YouTubeConfig, YouTubeConnector
...
class TestConnectorIntegration:
    ...
    def test_local_connector_with_deduplication(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from ai.pipelines.orchestrator.ingestion_deduplication import (
