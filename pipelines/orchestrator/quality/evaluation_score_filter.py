...
class EvaluationScoreFilter:
    ...
    def should_include_dataset(
        ...
        if evaluation_details:
            ...
            if (
                data_structure is not None
                and data_structure < self.min_data_structure_quality
            ):
                return False, (
            ...
            if (
                training_integration is not None
                and training_integration < self.min_training_integration
            ):
                return False, (
