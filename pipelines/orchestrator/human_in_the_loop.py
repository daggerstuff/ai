    ...
    def _bundle_to_dict(self, bundle: LabelBundle) -> Dict[str, Any]:
        ...
        return {
            ...
            "mental_health_condition_label": {
                "conditions": [
                    c.value for c in bundle.mental_health_condition_label.conditions
                ]
                ...
                "primary_condition": bundle.mental_health_condition_label.primary_condition.value
                if bundle.mental_health_condition_label
                and bundle.mental_health_condition_label.primary_condition
                else None,
                "co_morbidities": [
                    c.value for c in bundle.mental_health_condition_label.co_morbidities
                ]
                if bundle.mental_health_condition_label
                else [],
                "metadata": {
            ...
            "demographic_label": {
                "demographics": [d.value for d in bundle.demographic_label.demographics]
    ...
    def _dict_to_bundle(self, data: Dict[str, Any]) -> LabelBundle:
        ...
        if data.get("mental_health_condition_label"):
            ...
            condition_label = MentalHealthConditionLabel(
                ...
                primary_condition=MentalHealthConditionType(
