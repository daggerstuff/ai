...
from analytics_orchestrator import (
    ...
    StreamingAnalyticsOrchestrator,
)
    ...
    return [
        {
            ...
            "messages": [
                ...
                {
                    "role": "therapist",
                    "content": "I understand. Can you tell me more about what's making you feel sad?",
                },
                {"role": "client", "content": "Work has been stressful."},
                {
                    "role": "therapist",
                    "content": "Work stress can be difficult. What specifically at work is causing you stress?",
                },
            ],
        },
        {
            ...
            "messages": [
                {
                    "role": "client",
                    "content": "I've been experiencing anxiety attacks lately. They seem to come out of nowhere and I feel like I can't breathe.",
                },
                {
                    "role": "therapist",
                    "content": "Panic attacks can be very frightening. When you say they come out of nowhere, have you noticed any patterns or triggers? Sometimes there are subtle cues our body picks up on before we're consciously aware.",
                },
                {
                    "role": "client",
                    "content": "Now that you mention it, they often happen when I'm in crowded places or when I have to speak in meetings.",
                },
                {
                    "role": "therapist",
                    "content": "That's a really important observation. It sounds like social situations might be a trigger for you. Let's explore some coping strategies you can use when you notice those early warning signs.",
                },
            ],
        },
        {
            ...
            "messages": [
                {
                    "role": "client",
                    "content": "I've been reflecting on our previous sessions about my attachment patterns. I think I'm starting to see how my childhood experiences with my emotionally unavailable father are playing out in my romantic relationships.",
                },
                {
                    "role": "therapist",
                    "content": "That's a profound insight. The fact that you're making these connections between your early attachment experiences and current relational patterns shows significant therapeutic progress. Can you help me understand what specific patterns you're noticing?",
                },
                {
                    "role": "client",
                    "content": "I realize I have this anxious attachment style where I constantly seek reassurance from my partner, but then I also push them away when they get too close. It's like I'm terrified of both abandonment and intimacy simultaneously.",
                },
                {
                    "role": "therapist",
                    "content": "You've just articulated something that many people struggle to put into words - that paradox of craving connection while simultaneously fearing it. This kind of ambivalent attachment often develops as an adaptive response to inconsistent caregiving. Now that you have this awareness, we can work on developing more secure attachment behaviors.",
                },
            ],
        },
        {
            ...
            "messages": [
                {
                    "role": "client",
                    "content": "I've been practicing the mindfulness techniques we discussed, and I'm noticing something interesting about my dissociative episodes. There seems to be a somatic component - I feel this disconnection starting in my chest before my mind goes blank.",
                },
                {
                    "role": "therapist",
                    "content": "That's a remarkable level of somatic awareness you're developing. The fact that you're tracking the embodied precursors to dissociation suggests your window of tolerance is expanding. From a polyvagal theory perspective, what you're describing sounds like you're catching the dorsal vagal shutdown before it fully engages.",
                },
                {
                    "role": "client",
                    "content": "Yes, exactly. And when I notice that chest sensation, I've been using the bilateral stimulation technique you taught me. It seems to help me stay more present and connected to my body.",
                },
                {
                    "role": "therapist",
...
def create_configuration_files():
    ...
    analytics_config = {
        ...
        "data_sources": [
            ...
            {
                "type": "websocket",
                "config": {"uri": "ws://localhost:8765", "reconnect_interval": 5.0},
            },
        ],
        "pattern_recognition": {
