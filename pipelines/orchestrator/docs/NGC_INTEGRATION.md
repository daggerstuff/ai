...
```python
from ai.pipelines.orchestrator.sourcing.ngc_ingestor import NGCIngestor, ingest_ngc_datasets
...
```python
from ai.pipelines.orchestrator.sourcing.multi_source_ingestor import MultiSourceIngestor
from ai.pipelines.orchestrator.sourcing.ngc_ingestor import NGCIngestor
...
Edit `ai/pipelines/orchestrator/sourcing/ngc_ingestor.py`:
