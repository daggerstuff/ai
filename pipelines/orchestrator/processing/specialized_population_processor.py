...
class SpecializedPopulationProcessor:
    ...
    def process_population_data(
        self, data: list[dict[str, Any]], population: SpecializedPopulation
    ) -> list[Conversation]:
        ...
        self.logger.info(
            f"Processed {len(conversations)} conversations for {population.value}"
        )
        return conversations

    def _create_population_conversation(
        self, item: dict[str, Any], population: SpecializedPopulation
    ) -> Conversation | None:
        ...
        try:
            ...
            return Conversation(
                ...
                metadata={
                    "specialized_population": population.value,
