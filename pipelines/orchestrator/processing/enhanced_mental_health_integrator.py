...
from ai.pipelines.orchestrator.processing.dataset_format_adapters import AdapterRegistry
...
class EnhancedMentalHealthIntegrator:
    ...
    def integrate_all_datasets(
        ...
        if include_tier2 and self.tier2_loader:
            ...
            logger.info(f"✅ Tier 2 complete: {len(tier2_conversations)} conversations")
    ...
    def _print_summary(self):
        ...
        logger.info(
            f"Total Processed: {self.telemetry.total_conversations_processed:,}"
        )
