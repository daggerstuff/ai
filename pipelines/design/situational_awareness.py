...
class SituationalAwarenessAgent:
    ...
    def analyze(self, text: str) -> SituationalContext:
        ...
        relationship_matches = self._match_patterns(
            text_lower, self.RELATIONSHIP_CONTEXT
        )
        ...
        if is_growth and has_metaphor:
            reasoning_parts.append(
                "Growth-focused with metaphorical language (NOT literal crisis)"
            )
        ...
        if dv_matches and relationship_matches:
            reasoning_parts.append(
                "Domestic violence in relationship context (NOT general crisis)"
            )
        if is_resolved and has_trauma_words:
            reasoning_parts.append(
                "Past trauma (FULLY PROCESSED/RESOLVED, NOT active treatment)"
            )

        reasoning = (
            "; ".join(reasoning_parts)
            if reasoning_parts
            else "Standard therapeutic conversation"
        )
...
if __name__ == "__main__":
    ...
    test_cases = [
        (
            "I feel like my old self is dying as I become someone new.",
            "Growth/metaphorical",
        ),
        ...
        (
            "Learning to cope with depression through CBT.",
            "Processing/mental health support",
        ),
    ]
    ...
    for text, label in test_cases:
        ...
        print(
            f"Crisis: {context.is_crisis}, Growth: {context.is_growth_focused}, "
