...
Processed 100 therapeutic conversation records from the training dataset using the keyword-based taxonomy classifier (hybrid classifier with LLM disabled).
...
3. **Clear Patterns**: Mental health support and trauma processing dominate (64% combined)
