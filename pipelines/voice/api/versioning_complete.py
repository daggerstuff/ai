...
def v1_endpoint(path: str, **kwargs):
    ...
    return versioned_endpoint(
        [APIVersion.V1_0, APIVersion.V1_1], f"/v1{path}", **kwargs
    )
...
def v2_endpoint(path: str, **kwargs):
    ...
    return versioned_endpoint(
        [APIVersion.V2_0, APIVersion.V2_1], f"/v2{path}", **kwargs
    )
...
class BackwardCompatibility:
    ...
    def transform_v1_to_v2_request(request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        field_mappings = {"msg": "message", "lang": "language", "opts": "options"}
    ...
    def transform_v2_to_v1_response(response_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        field_mappings = {"message": "msg", "language": "lang", "options": "opts"}
    ...
    @staticmethod
    def get_version_specific_schema(
        version: str, base_schema: Dict[str, Any]
    ) -> Dict[str, Any]:
...
def setup_versioned_routes(app: FastAPI):
    ...
    async def get_api_versions(
        version_manager: APIVersionManager = Depends(get_version_manager),
    ):
        """Get information about all API versions."""
        return {
            "versions": {
                v: version_manager.get_version_info(v).dict()
    ...
    async def transcribe_v1(
        request: Request, current_version: str = Depends(get_current_version)
    ):
    ...
    async def transcribe_v2(
        ...
        result = {
            "result": {
                ...
                "confidence": 0.95,
                "metadata": {"processing_time": 1.23, "model_version": "v2.1"},
            }
        }
