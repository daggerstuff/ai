...
from .hindsight_local_adapter import (
    ...
    hindsight_document_summary_from_storage,
    metadata_to_tags,
    normalize_tags,
    serialize_context,
)
from .hindsight_local_retention import build_scoped_retain_items
from .local_hindsight_repository import LocalHindsightRepository
from .local_hindsight_search import build_recall_results
...
class LocalHindsightDocumentService:
    """Hindsight-compatible document operations backed by the local repository."""
    ...
    def get_document(
        ...
        *,
        ...
        if not record:
            return None
        return hindsight_document_from_storage(record)
