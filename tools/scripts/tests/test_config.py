...
class TestAuthConfig:
    ...
    def test_auth_config_validation(self):
        ...
        # Valid config
        auth_config = AuthConfig(client_id="test_client", client_secret="test_secret")
...
class TestAPIConfig:
    ...
    def test_api_config_validation(self):
        ...
        # Valid config
        api_config = APIConfig(base_url="http://api.example.com", timeout=30)
...
class TestConfigProfile:
    ...
    def test_config_profile_validation(self):
        ...
        with pytest.raises(ValueError):
            ConfigProfile(name="", api_base_url="http://invalid.example.com")

        # Invalid profile - invalid URL
        with pytest.raises(ValueError):
            ConfigProfile(name="invalid_profile", api_base_url="invalid-url")
