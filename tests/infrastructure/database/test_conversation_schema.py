...
class TestDatabaseSchemaDesigner:
    def test_estimate_storage_requirements_edge_cases(self):
        ...
        assert result_0["summary"]["total_estimated_size_gb"] == 0.65  # Base overhead (0.5 for other_tables + 30% index overhead)
        ...
        assert result_negative["conversation_count"] == -1
        assert result_negative["summary"]["total_estimated_size_gb"] == 0.65 # The round operation can make it equal to base
