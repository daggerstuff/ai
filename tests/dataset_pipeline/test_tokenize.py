...
try:
    from ai.core.pipelines.processing.chatml_tokenizer import tokenize_dataset
except ImportError:
...
class TestTokenizePipeline:
    def test_basic_tokenization(self):
        ...
        with patch(
            "ai.pipelines.processing.chatml_tokenizer.get_tokenizer",
    ...
    def test_tokenization_statistics(self):
        ...
        with patch(
            ...
            with patch(
                "ai.pipelines.processing.chatml_tokenizer.log_tokenization_stats"
            ) as mock_log:
                tokenize_dataset(
                    df, tokenizer_name="mock", text_fields=["prompt", "response"]
                )
    ...
    def test_privacy_bias_hook_integration(self):
        ...
        with patch(
            ...
            with patch(
                "ai.pipelines.processing.chatml_tokenizer.privacy_bias_hook"
            ) as mock_hook:
                tokenize_dataset(
                    df, tokenizer_name="mock", text_fields=["prompt", "response"]
                )
