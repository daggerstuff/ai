...
async def simulate_therapy_session_async(
    ...
    *,
    ...
    base_prompt = (
        ...
        "- NEVER open with or use sycophantic cliches like 'I hear how', 'I can hear', 'It sounds like', "
        "'That sounds really', 'It makes sense that you feel', or 'Thank you for sharing'.\n"
        "- NEVER cave or backtrack with 'You're right', 'I apologize', 'I stand corrected', 'Sorry for', "
        "'My mistake', 'I'll stop', or 'Fair enough'. Hold your clinical position.\n"
