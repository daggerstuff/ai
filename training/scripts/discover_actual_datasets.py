...
def discover_datasets():
    ...
    try:
        ...
        dataset_files = [
            ...
            if any(obj.endswith(ext) for ext in [".jsonl", ".csv", ".json", ".txt"])
        ]
        ...
        priority_files = [
            f for f in dataset_files if "priority" in f.lower() and f.endswith(".jsonl")
        ]
        if priority_files:
        ...
        mental_health_files = [
            ...
            if "mental_health" in f.lower() or "mental" in f.lower()
        ]
        ...
        chat_files = [
            ...
            if any(
                term in f.lower()
                for term in ["soulchat", "counsel_chat", "counselchat"]
            )
        ]
        if chat_files:
