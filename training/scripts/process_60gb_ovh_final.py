...
commands_content=\"$commands_inner\"
echo \"$$commands_content\" > training_ready/data/ovh_60gb_processed/commands.sh
chmod +x training_ready/data/ovh_60gb_processed/commands.sh
""")

    commands_template = Template(r"""#!/bin/bash
...
""")
    ...
    commands_inner = commands_template.substitute(
