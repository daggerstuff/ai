#!/usr/bin/env python3
"""
HETZNER AI Deploy Inference Server for Pixelated Empathy
...
app = FastAPI(
    ...
    description="HETZNER AI Deploy inference server for therapeutic conversation AI",
    version="1.0.0",
    lifespan=lifespan,
)
