...
**HETZNER S3 credentials** (preferred):

```bash
# In .env file or environment
HETZNER_S3_ACCESS_KEY="your_access_key"
HETZNER_S3_SECRET_KEY="your_secret_key"
HETZNER_S3_ENDPOINT="https://hel1.your-objectstorage.com"  # Optional, has default
HETZNER_S3_REGION="hel1"  # Optional, has default
```

**Fallback options** (for compatibility):

- Legacy `OVH_ACCESS_KEY` / `OVH_SECRET_KEY` (legacy support)
...
```python
from ai.training.ready_packages.utils.s3_dataset_loader import S3DatasetLoader, FileNotFoundError
