...
def analyze_dataset(dataset_path: Optional[str] = None, s3_path: Optional[str] = None):
    ...
    if s3_path:
        ...
        from ai.training.ready_packages.utils.s3_dataset_loader import get_s3_dataset_path, load_dataset_from_s3
        try:
...
def main():
    ...
    try:
        ...
        if training_start_time:
            total_duration = (datetime.now(timezone.utc) - training_start_time).total_seconds() / 3600
