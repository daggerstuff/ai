...
class PixelVoiceLoader:
    ...
    def __init__(self, pixel_voice_dir: str = "ai/pipelines/pixel_voice"):
        ...
        self.therapeutic_pairs_file = (
            self.pipeline_dir / "data" / "therapeutic_pairs" / "therapeutic_pairs.json"
        )
        self.dialogue_pairs_file = (
            self.pipeline_dir
            / "data"
            / "dialogue_pairs"
            / "dialogue_pairs_validated.json"
        )
    ...
    def convert_to_training_format(
        self, pairs: Optional[List[VoiceDialoguePair]] = None
    ) -> List[Dict]:
...
if __name__ == "__main__":
    ...
    if not loader.check_pipeline_output_exists():
        ...
        if training_data:
            ...
            print(
                f"   Transcription quality: {sample['metadata']['transcription_quality']:.2f}"
            )
