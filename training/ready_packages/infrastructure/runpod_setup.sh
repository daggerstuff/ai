...
# Fetch the dataset from HETZNER S3 to local NVMe storage before epoch 1
echo "Fetching Dataset from S3..."
aws --endpoint-url https://hel1.your-objectstorage.com s3 cp s3://pixel-data/final_dataset/ /workspace/data_cache/ --recursive
