...
def analyze_dataset(dataset_path: Optional[str] = None, s3_path: Optional[str] = None):
    """
    ...
    if s3_path:
        ...
        try:
            ...
            print(f"   Auto-loaded from S3: {s3_path}")
...
def main():
    ...
    try:
        ...
        wandb.log(
            {
                ...
                "optimization/gradient_accumulation": (
                    profile.gradient_accumulation_steps
                ),
                "optimization/effective_batch_size": (
                    profile.batch_size * profile.gradient_accumulation_steps
                ),
        ...
        train_pct = (trainable_params / total_params) * 100
        print(f"   Trainable: {trainable_params:,} ({train_pct:.2f}%)")
        ...
        if not shutdown_requested:
            ...
            eff_bs = profile.batch_size * profile.gradient_accumulation_steps
            ...
            wandb.log(
                {
                    ...
                    "training/time_accuracy": (
                        estimate.estimated_hours / actual_duration
                    )
                    * 100,
                }
            )
            ...
            accuracy = (estimate.estimated_hours / actual_duration) * 100
