...
class QualityImprovementTracker:
    ...
    def track_quality_improvements(
        ...
        try:
            ...
            baseline_data = self._get_period_data(
                baseline_days + current_days, baseline_days
            )
    ...
    def create_improvement_visualizations(
        ...
        try:
            ...
            fig.suptitle(
                "Quality Improvement Tracking Dashboard", fontsize=16, fontweight="bold"
            )
            ...
            colors = [
                "green" if p > 0 else "red" if p < -2 else "orange" for p in percentages
            ]
    ...
    def _create_executive_summary(
        ...
        try:
            ...
            stable_metrics = [
                m
                for m, i in improvements.items()
                if i.improvement_direction == "stable"
            ]
