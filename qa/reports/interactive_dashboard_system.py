...
if __name__ == '__main__':
    ...
    logger.info("Interactive Dashboard Server Starting...")
    logger.info("Access your dashboards at:")
    logger.info("   • Executive Dashboard: http://localhost:5000/executive")
    logger.info("   • Operational Dashboard: http://localhost:5000/operational")
    logger.info("   • Technical Dashboard: http://localhost:5000/technical")
    logger.info("Dashboards will auto-refresh every 30 seconds")
