...
class QualityComparisonReporter:
    ...
    def _generate_executive_summary(
        ...
        if dataset_comparisons:
            ...
            if significant_dataset_comparisons:
                summary.append(
                    f"📁 {len(significant_dataset_comparisons)} significant differences detected between datasets"
                )
    ...
    def _generate_detailed_insights(
        ...
        if component_comparisons:
            ...
            insights.append(
                f"📊 Most variable component comparison: {most_variable.group1_name} vs {most_variable.group2_name}"
            )
