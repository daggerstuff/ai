...
STAGES: dict[str, StageConfig] = {
    ...
    STAGE2_ID: StageConfig(
        ...
        target_share=0.25,
        description=(
            "Structured reasoning, diagnosis scaffolding, knowledge grounding, and summarization style examples."
        ),
    ),
    STAGE3_ID: StageConfig(
        ...
        target_share=0.20,
        description=(
            "Nightmare edge cases, crisis scenarios, Reddit/raw edge pipelines, and high‑intensity stress tests."
        ),
    ),
    STAGE4_ID: StageConfig(
        ...
        target_share=0.15,
        description=(
            "Tim‑Fletcher‑style voice, persona consistency, dual‑persona scripts, and delivery-focused training."
        ),
    ),
}
